...
- `best_practices` - researched best practices from MCP (SQLAlchemy transactions, PostgreSQL NOTIFY)
- `db_config` - database type, ORM settings, trigger/notify patterns found in migrations
