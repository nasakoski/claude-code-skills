...
try {
    ...
    run(["checkpoint", "--project-root", projectRoot, "--epic", "7", "--phase", "PHASE_6_DELEGATE"]);
    run(["advance", "--project-root", projectRoot, "--epic", "7", "--to", "PHASE_7_FINALIZE"]);
    run(["checkpoint", "--project-root", projectRoot, "--epic", "7", "--phase", "PHASE_7_FINALIZE", "--payload", "{\"final_result\":\"CREATED\"}"]);
    run(["advance", "--project-root", projectRoot, "--epic", "7", "--to", "PHASE_8_SELF_CHECK"]);
    run(["checkpoint", "--project-root", projectRoot, "--epic", "7", "--phase", "PHASE_8_SELF_CHECK", "--payload", "{\"pass\":true,\"final_result\":\"CREATED\"}"]);
