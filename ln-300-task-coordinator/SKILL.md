...
5. Verify foundation-first ordering and 1-8 task count
6. Save the traceability table and layer grouping to `.hex-skills/task-planning/{identifier}_traceability.md`
